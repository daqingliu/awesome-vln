...
A curated list of research papers in Vision-Language Navigation (VLN). Link to the code and website if available is also present.
...
1. **HoME: a Household Multimodal Environment** <br>
...
1. **Talk the Walk: Navigating New York City through Grounded Dialogue** <br>
...
1. **Touchdown: Natural Language Navigation and Spatial Reasoning in Visual Street Environments** <br>
...
1. **Vision-based Navigation with Language-based Assistance via Imitation Learning with Indirect Intervention** <br>
...
1. **Learning To Follow Directions in Street View** <br>
...
1. **Stay on the Path: Instruction Fidelity in Vision-and-Language Navigation** <br>
...
1. **Vision-and-Dialog Navigation** <br>
...
1. **Help, Anna! Visual Navigation with Natural Multimodal Assistance via Retrospective Curiosity-Encouraging Imitation Learning** <br>
...
1. **Talk2Nav: Long-Range Vision-and-Language Navigation with Dual Attention and Spatial Memory** <br>
...
1. **Cross-Lingual Vision-Language Navigation** <br>
...
1. **Just Ask: An Interactive Learning Framework for Vision and Language Navigation** <br>
   *Ta-Chung Chi, Mihail Eric, Seokhwan Kim, Minmin Shen, Dilek Hakkani-tur* <br>
   AAAI, 2020. [[Paper]](https://arxiv.org/abs/1912.00915)

1. **Towards Learning a Generic Agent for Vision-and-Language Navigation via Pre-training** <br>
...
1. **Environment-agnostic Multitask Learning for Natural Language Grounded Navigation** <br>
...
1. **Multi-View Learning for Vision-and-Language Navigation** <br>
...
1. **Vision-Dialog Navigation by Exploring Cross-modal Memory** <br>
...
1. **Take the Scenic Route: Improving Generalization in Vision-and-Language Navigation** <br>
   *Felix Yu, Zhiwei Deng, Karthik Narasimhan, Olga Russakovsky* <br>
   arXiv, 2020. [[Paper]](https://arxiv.org/abs/2003.14269)

1. **Sub-Instruction Aware Vision-and-Language Navigation** <br>
